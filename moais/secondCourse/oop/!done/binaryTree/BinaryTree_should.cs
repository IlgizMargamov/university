...
namespace Generics.BinaryTrees
{
	...
	public class BinaryTree_should
	{
		...
		[Test]
		public void BeEmptyWhenCreated1()
		{
			var binaryTree = new BinaryTree<string>();
			var a = binaryTree.GetEnumerator();
			CollectionAssert.AreEqual(new string[0], binaryTree);
		}
		...
		[Test]
		public void EnumerationIsLazyMini()
		{
			var r = new Random();
			var items = Enumerable.Range(0, 5).Select(i => r.Next(0, 15));
			var tree = BinaryTree.Create(items.ToArray());
			RunWithTimeout(1000, "tree.First() is too slow. Enumeration is not lazy?",
				() =>
				{
