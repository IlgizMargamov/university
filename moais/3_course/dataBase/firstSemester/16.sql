...
BEGIN
    return coalesce((select count(*) from library.book_in_lib bil where bil.lib_book_id = pBookId), 0);
END
$$ LANGUAGE plpgsql;
...
begin;
insert into book_in_lib (lib_book_id, status_id) values (1,3), (1,3),(1,3),(1,3),(1,3),(1,3) ;
delete from book_in_lib where status_id=3ж
end;
...
create temp table temp_table as select * from library.book;
